...
import com.lkl.ansuote.modulemodel.R;
...
public class SslContextFactory {
    ...
    public static SSLSocketFactory getSSLSocketFactoryForTwoWay() {
        try {
            InputStream certificate = ModuleModel.sApplication.getResources().openRawResource(R.raw.capk);
            ...
            clientKeyStore.load(ModuleModel.sApplication.getResources().openRawResource(R.raw.cabks), TRUST_CA_PWD.toCharArray());
